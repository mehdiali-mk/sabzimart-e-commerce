  ...
  return (
    <div className="mt-16 pb-16">
      ...
      {myOrders.map((order, index) => (
        <div
          key={index}
          className="border border-gray-300 rounded-lg mb-10 p-4 py-5 max-w-4xl group"
        >
          <p className="flex justify-between md:items-center text-gray-400 md:font-medium max-md:flex-col">
            ...
            <span className="flex items-center justify-center gap-1">
              ...
              <span className="font-bold text-primary transition text-xl">
                {currency}
                {order.amount}
              </span>
            </span>
          ...
          {order.items.map((item, index) => (
            ...
            >
              ...
              <p className="text-lg font-medium flex items-center justify-center gap-1">
                <span>Amount: </span>
                <span className="text-lg group-hover:text-primary transition font-bold">
                  {currency}
